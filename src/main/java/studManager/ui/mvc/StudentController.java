...
import studManager.ui.Student;
import studManager.ui.StudentRepository;
...
public class StudentController {
	...
	public ModelAndView create(@Valid Student student, BindingResult result,
		...
		redirect.addFlashAttribute("globalStudent", "Successfully created a new student");
